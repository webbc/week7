 ...
 * 
 */
public class TakeActivity extends BaseActivity implements OnClickListener,
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case TAKE_EXPRESS_SUCCESS:
				ToastUtils.showToast(TakeActivity.this, (String) msg.obj);
				Intent intent = new Intent(TakeActivity.this,
			...
			// 请求错误
			case REQUEST_ERROR:
				ToastUtils.showToast(TakeActivity.this, "请求错误");
				break;
			}
		}
	...
	private void initData() {
		...
		new Thread() {
			public void run() {
				SchoolDao schoolDao = new SchoolDao(TakeActivity.this);
	...
	public void onItemSelected(AdapterView<?> parent, View view, int position,
		...
		case R.id.sp_express_weight:
			...
			case 3:
				mLarge = 4;
				mMoney = 2;
				tvExpressWeighDdesc.setText("特大件不支持积分支付");
				break;
			case 4:
				mLarge = 2;
				mMoney = 1;
				tvExpressWeighDdesc.setText("长宽高23cmX13cmX16cm以内只要1元哟");
				break;
			case 5:
				mLarge = 3;
				mMoney = 2;
				tvExpressWeighDdesc.setText("这么大的快递小哥只要2元哟");
				break;
			}
			break;
		case R.id.sp_time:
